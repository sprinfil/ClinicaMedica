            ...
            <div class="w-screen h-screen z-[30] absolute top-0 left-0 items-center justify-center flex">
                ...
                <div class="bg-negro-menu rounded-md overflow-auto md:w-[800px] w-full md:h-auto h-auto">
                      ...
                      <div class="w-full h-[200px] flex items-center justify-center">
                        <p class="text-fuente text-[20px]">¿Seguro que deseas eliminar {{$tratamiento->tratamiento}}?</p>
                      </div>
                      <form action="{{route('tratamiento_delete',['tratamiento_id'=>$tratamiento->id,'paciente_id'=>$paciente->id])}}" method="GET">
                        ...
                        <div class="bg-negro-fondo w-full h-[100px] flex justify-end py-5">
                            <p class="btn-primary right-0 mr-5 bg-rojo items-center flex" wire:click="salir">Cancelar</p>
