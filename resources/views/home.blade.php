        ...
        <div class="mt-[25px] grid md:grid-cols-4 grid-cols-1 gap-4">
                ...
                <div
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-[90px] text-fuente-botones mt-[20px]">
            ...
            <a href="{{ route('corte_caja') }}">
                <div
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-[90px] text-fuente-botones mt-[20px] ml-[20px]">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('configuracion') }}">
                    <div
                        ...
                        <div>
                            ...
                            stroke-width="1.5" stroke="currentColor" class="w-[90px] text-fuente-botones mt-[20px]">
                            <path stroke-linecap="round" stroke-linejoin="round"
